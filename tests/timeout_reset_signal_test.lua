...
assert(normalized.production_timeout_reset_signal.name == "signal-R")
assert(normalized.recursion_timeout_reset_signal.type == "item")
local green = {
...
local production_record = {entity = entity, config = {
  ...
  production_timeout_reset_signal = reset, additional_production_rate = 0,
...
local supermarket_record = {entity = entity, config = {
  ...
  recurise_depth = 0, recursion_timeout = 1, recursion_timeout_reset_signal = reset
}}
...
supermarket_record = {entity = entity, config = {
  production_machine = "assembler", recursion_output_mode = "single", sequential_production = false,
  recurise_depth = 0, recursion_timeout = 0, recursion_timeout_reset_signal = reset
}}
green[2].count = 1
game.tick = 0
SupermarketOrder.calculate(supermarket_record)
